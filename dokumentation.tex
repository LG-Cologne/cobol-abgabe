...
%    \thispagestyle{plain}
    ...
    % =========== Zahlenteil ===========
    \include{chapters/1-Programmentwurf}
    \include{chapters/2-Mathematische_Verfahrensbeschreibung}
    \include{chapters/3-Testdokumentation}
    \addtocontents{toc}{\protect\newpage}
    % ============= Buchstabenteil ==============
    \renewcommand{\thechapter}{\Alph{chapter}}%
    \setcounter{chapter}{0}
    % \include{chapters/C-Entwicklungsumgebung} zusammen legen mti Hilfmittel
